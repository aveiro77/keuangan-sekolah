            ...
            <div class="flex items-center">
                ...
                <nav class="ml-4 w-full rounded-md">
                    <ol class="list-reset flex">
                        ...
                        <li class="text-neutral-500 dark:text-neutral-400">Operasional</li>
                    </ol>
                </nav>
            </div>
        </template>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6 text-gray-900">
                       <div class="flex flex-col">
                            <div class="row">
                                    <div class="col-md-3">
                                        <Link href="/transaksi/opr/create" type="button" class="btn btn-outline-dark rounded-0 py-2 w-full">Tambah Transaksi</Link>
                                    </div>
                                    <div class="col-md-9">
                               ...
                               <div class="inline-block min-w-full py-2 sm:px-6 lg:px-8">
                                   <div class="overflow-hidden">
                                       ...
                                       <thead class="border-b font-medium dark:border-neutral-500">
                                           ...
                                           <th scope="col" class="px-6 py-4">Rekanan</th>
                                           <th scope="col" class="px-6 py-4">Keterangan</th>
                                           <th scope="col" class="px-6 py-4 text-right">Total (Rp)</th>
                                       ...
                                       <tbody>
                                           <tr v-for="trx in transactions.data" :key="trx" class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-200">
                                               ...
                                               <td class="whitespace-nowrap px-6 py-2">{{ trx.partner.name }}</td>
                                               <td class="whitespace-nowrap px-6 py-2">{{ trx.description }}</td>
                                               <td class="whitespace-nowrap px-6 py-2 text-right">{{ trx.grand_total.toLocaleString('id-ID', { useGrouping: true, minimumFractionDigits: 0 }).replace(',', '.') }}</td>
                                               <td class="whitespace-nowrap px-6 py-2">{{ trx.coa.name }}</td>
                                               <td class="whitespace-nowrap px-6 py-2">
                                                   <Link :href="`/transaksi/opr/${trx.id}/edit`">Edit</Link> 
                                                   |
                                                   <Link :href="`/transaksi/opr/${trx.id}`" method="delete" onclick="return confirm('Anda yakin??')">Hapus</Link> 
                                               </td>
                                           </tr>
                                       </tbody>
                                       </table>
