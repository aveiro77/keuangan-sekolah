            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 w-1/3">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form class="row g-3" @submit.prevent="form.post('/transaksi/pemasukan')">
                                <div class="col-12" id="selectt">
                                    ...
                                    <select id="source" class="form-select" name="source" v-model="form.source">
                                        ...
                                        <option value="Dana B.O.S" >Dana B.O.S</option>
                                        <option value="Sumbangan Wali Murid / Instansi">Sumbangan Wali Murid / Instansi</option>
                                    </select>
                                    <span class="text-sm text-danger" v-if="form.errors.description">{{ form.errors.source }}</span>
                                </div>
                                <div class="col-12" id="selectt">
                                    <label for="coa_id" class="form-label">Rekening Pemasukan</label>
                                    <select id="coa_id" class="form-select" name="coa" v-model="form.coa_id">
                                        <option value="">Pilih</option>
